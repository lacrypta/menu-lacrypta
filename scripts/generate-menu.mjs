#!/usr/bin/env node
// Genera public/index.html: el menú del evento de La Crypta (Barra, Comida, Merch)
// con el look & feel de LaPOS. Fuentes y logo embebidos en base64 -> archivo
// portátil. En pantalla es responsive; al imprimir, cada menú ocupa una hoja A4.
//
// Para actualizar el menú: editá data/*.json y corré `node scripts/generate-menu.mjs`.
...
const barra = readJSON('data/barra.json')
const comida = readJSON('data/comida.json')
const merch = readJSON('data/merch.json')

// Orden de categorías y nº de columnas por menú.
// Merch usa 2 columnas para que sus items entren en una sola hoja A4.
const menus = [
...
const iaab3 = fontB64('fonts/IAAB3.woff2')
const sfReg = fontB64('fonts/SF-Regular.woff2')
const sfBold = fontB64('fonts/SF-Bold.woff2')
...
<head>
  ...
  <meta name="description" content="Menú del evento de La Crypta: Barra, Comida y Merch. Pagá con Bitcoin · Lightning." />
  <meta name="theme-color" content="#1C1C1C" />
  <link rel="icon" type="image/png" href="/icon.png" />
  <link rel="apple-touch-icon" href="/icon.png" />
  <link rel="canonical" href="https://menu.lacrypta.ar/" />
  <meta property="og:type" content="website" />
  <meta property="og:title" content="La Crypta · Menú del evento" />
  <meta property="og:description" content="Barra, Comida y Merch. Pagá con Bitcoin · Lightning." />
  <meta property="og:url" content="https://menu.lacrypta.ar/" />
  <meta property="og:image" content="https://menu.lacrypta.ar/icon.png" />
...
console.log(`OK  public/index.html generado (${total} items · ${menus.length} hojas A4)`)
